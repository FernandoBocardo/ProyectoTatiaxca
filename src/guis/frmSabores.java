...
public class frmSabores extends javax.swing.JFrame {
     ...
     */
    public frmSabores(List<ProductoCarrito> productosCarrito, ProductoCarrito productoCarrito) {
        initComponents();
    ...
    {
        new frmDetalles(productosCarrito, productoCarrito).setVisible(true);
        this.dispose();
    }

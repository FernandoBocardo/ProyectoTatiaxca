...
public class PanelBotonProducto extends javax.swing.JPanel {
    ...
    private void continuar(int i)
    {
        ...
        switch(categoriaInt)
        {
            ...
            default:
            {
                Producto producto = CtrlProductos.getInstance().consultarPorNombre(frmProductos.productoCarrito.getNombre());
                this.frmProductos.productoCarrito.setPrecio(producto.getPrecioVenta());
                this.frmProductos.productoCarrito.setCantidad(1);
                this.frmProductos.productoCarrito.setUnidadMedida("");
                this.frmProductos.productoCarrito.setSabor("");
                this.frmProductos.productosCarrito.add(frmProductos.productoCarrito);
                new frmCarrito(frmProductos.productosCarrito).setVisible(true);
            }
        }
